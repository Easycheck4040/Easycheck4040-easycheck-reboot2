...
const resources = {
  ...
  en: {
    translation: {
      ...
      "pricing.subtitle": "Choose the plan that fits your business size.",
      "pricing.most_popular": "Most Popular",
      "pricing.choose_plan": "Choose Plan",
      "pricing.starter_desc": "Perfect for freelancers and side-hustles.",
      "pricing.pro_desc": "For growing businesses that need full automation.",
      "pricing.enterprise_desc": "For large organizations with custom needs.",
      "pricing.feat_invoices": "Unlimited Invoices",
      "pricing.feat_clients": "Up to 50 Clients",
      "pricing.feat_basic_support": "Basic Support",
      "pricing.feat_no_ai": "Basic AI Features",
      "pricing.feat_chat": "AI Chat Assistant",
      "pricing.feat_automation": "Full Automation",
      "pricing.feat_everything_starter": "Everything in Starter",
      "pricing.feat_unlimited_ai": "Unlimited AI Actions",
      "pricing.feat_chat_247": "24/7 AI Chat Advisor",
      "pricing.feat_auto_email": "Automated Email Responses",
      "pricing.feat_priority": "Priority Support",
      "pricing.feat_everything_pro": "Everything in Pro",
      "pricing.feat_custom_api": "Custom API Access",
      "pricing.feat_dedicated": "Dedicated Account Manager",
      "pricing.feat_training": "Team Training",
      "pricing.enterprise_contact": "Need a custom plan?"
    }
  },
  ...
  pt: {
    translation: {
      ...
      "pricing.subtitle": "Escolhe o plano que melhor se adapta ao teu negócio.",
      "pricing.most_popular": "Mais Popular",
      "pricing.choose_plan": "Escolher Plano",
      "pricing.starter_desc": "Perfeito para freelancers e pequenos negócios.",
      "pricing.pro_desc": "Para empresas em crescimento que precisam de automação total.",
      "pricing.enterprise_desc": "Para grandes organizações com necessidades personalizadas.",
      "pricing.feat_invoices": "Faturas Ilimitadas",
      "pricing.feat_clients": "Até 50 Clientes",
      "pricing.feat_basic_support": "Suporte Básico",
      "pricing.feat_no_ai": "Funcionalidades IA Básicas",
      "pricing.feat_chat": "Chat Assistente IA",
      "pricing.feat_automation": "Automação Completa",
      "pricing.feat_everything_starter": "Tudo do Starter",
      "pricing.feat_unlimited_ai": "Ações IA Ilimitadas",
      "pricing.feat_chat_247": "Consultor IA 24/7",
      "pricing.feat_auto_email": "Respostas de Email Auto",
      "pricing.feat_priority": "Suporte Prioritário",
      "pricing.feat_everything_pro": "Tudo do Pro",
      "pricing.feat_custom_api": "Acesso API Personalizado",
      "pricing.feat_dedicated": "Gestor de Conta Dedicado",
      "pricing.feat_training": "Formação de Equipa",
      "pricing.enterprise_contact": "Precisas de um plano à medida?"
    }
  },
  ...
  fr: {
    translation: {
      ...
      "pricing.starter_desc": "Parfait pour les freelances.",
      "pricing.pro_desc": "Pour les entreprises en croissance.",
      "pricing.enterprise_desc": "Pour les grandes organisations.",
      "pricing.feat_invoices": "Factures Illimitées",
      "pricing.feat_clients": "Jusqu'à 50 Clients",
      "pricing.feat_basic_support": "Support De Base",
      "pricing.feat_no_ai": "Fonctions IA de Base",
      "pricing.feat_chat": "Chat Assistant IA",
      "pricing.feat_automation": "Automatisation Complète",
      "pricing.feat_everything_starter": "Tout dans Starter",
      "pricing.feat_unlimited_ai": "Actions IA Illimitées",
      "pricing.feat_chat_247": "Conseiller IA 24/7",
      "pricing.feat_auto_email": "Réponses Email Auto",
      "pricing.feat_priority": "Support Prioritaire",
      "pricing.feat_everything_pro": "Tout dans Pro",
      "pricing.feat_custom_api": "Accès API",
      "pricing.feat_dedicated": "Gestionnaire Dédié",
      "pricing.feat_training": "Formation Équipe",
      "pricing.enterprise_contact": "Besoin d'un plan sur mesure ?"
    }
  },
  ...
  es: {
    translation: {
      ...
      "pricing.starter_desc": "Perfecto para autónomos.",
      "pricing.pro_desc": "Para empresas en crecimiento.",
      "pricing.enterprise_desc": "Para grandes organizaciones.",
      "pricing.feat_invoices": "Facturas Ilimitadas",
      "pricing.feat_clients": "Hasta 50 Clientes",
      "pricing.feat_basic_support": "Soporte Básico",
      "pricing.feat_no_ai": "Funciones IA Básicas",
      "pricing.feat_chat": "Chat Asistente IA",
      "pricing.feat_automation": "Automatización Completa",
      "pricing.feat_everything_starter": "Todo en Starter",
      "pricing.feat_unlimited_ai": "Acciones IA Ilimitadas",
      "pricing.feat_chat_247": "Asesor IA 24/7",
      "pricing.feat_auto_email": "Respuestas Email Auto",
      "pricing.feat_priority": "Soporte Prioritario",
      "pricing.feat_everything_pro": "Todo en Pro",
      "pricing.feat_custom_api": "Acceso API",
      "pricing.feat_dedicated": "Gestor Dedicado",
      "pricing.feat_training": "Formación Equipo",
      "pricing.enterprise_contact": "¿Necesitas un plan a medida?"
    }
  },
  ...
  de: {
    translation: {
      ...
      "pricing.most_popular": "Beliebtestes",
      "pricing.choose_plan": "Plan Wählen",
      "pricing.starter_desc": "Perfekt für Freelancer.",
      "pricing.pro_desc": "Für wachsende Unternehmen.",
      "pricing.enterprise_desc": "Für große Organisationen.",
      "pricing.feat_invoices": "Unbegrenzte Rechnungen",
      "pricing.feat_clients": "Bis zu 50 Kunden",
      "pricing.feat_basic_support": "Basis-Support",
      "pricing.feat_no_ai": "Basis-KI-Funktionen",
      "pricing.feat_chat": "KI-Chat-Assistent",
      "pricing.feat_automation": "Vollständige Automatisierung",
      "pricing.feat_everything_starter": "Alles in Starter",
      "pricing.feat_unlimited_ai": "Unbegrenzte KI-Aktionen",
      "pricing.feat_chat_247": "24/7 KI-Berater",
      "pricing.feat_auto_email": "Auto-E-Mail-Antworten",
      "pricing.feat_priority": "Prioritäts-Support",
      "pricing.feat_everything_pro": "Alles in Pro",
      "pricing.feat_custom_api": "Benutzerdefinierte API",
      "pricing.feat_dedicated": "Dedizierter Manager",
      "pricing.feat_training": "Team-Schulung",
      "pricing.enterprise_contact": "Benötigen Sie einen individuellen Plan?"
    }
  },
  ...
  it: {
    translation: {
      ...
      "pricing.subtitle": "Scegli il piano più adatto alla tua azienda.",
      "pricing.most_popular": "Più Popolare",
      "pricing.choose_plan": "Scegli Piano",
      "pricing.starter_desc": "Perfetto per freelance.",
      "pricing.pro_desc": "Per aziende in crescita.",
      "pricing.enterprise_desc": "Per grandi organizzazioni.",
      "pricing.feat_invoices": "Fatture Illimitate",
      "pricing.feat_clients": "Fino a 50 Clienti",
      "pricing.feat_basic_support": "Supporto Base",
      "pricing.feat_no_ai": "Funzioni IA Base",
      "pricing.feat_chat": "Chat Assistente IA",
      "pricing.feat_automation": "Automazione Completa",
      "pricing.feat_everything_starter": "Tutto in Starter",
      "pricing.feat_unlimited_ai": "Azioni IA Illimitate",
      "pricing.feat_chat_247": "Consulente IA 24/7",
      "pricing.feat_auto_email": "Risposte Email Auto",
      "pricing.feat_priority": "Supporto Prioritario",
      "pricing.feat_everything_pro": "Tutto in Pro",
      "pricing.feat_custom_api": "Accesso API",
      "pricing.feat_dedicated": "Gestore Dedicato",
      "pricing.feat_training": "Formazione Team",
      "pricing.enterprise_contact": "Hai bisogno di un piano su misura?"
    }
  }
};
